...
const buildAppUnderTest = (options?: {
  ...
  layers?: {
    ...
    providerLoginManager?: Partial<ProviderLoginManager.ProviderLoginManager["Service"]>;
  ...
  Effect.gen(function* () {
    ...
    const servedRoutesLayer = HttpRouter.serve(makeRoutesLayer, {
      ...
      Layer.provide(
        Layer.mergeAll(
          ...
          Layer.mock(ProviderLoginManager.ProviderLoginManager)({
            attachStream: () => Effect.succeed(() => {}),
            write: () => Effect.void,
            resize: () => Effect.void,
            cancel: () => Effect.void,
            ...options?.layers?.providerLoginManager,
          }),
        ),
      ),
      Layer.provide(
    ...
    const appLayer = servedRoutesLayer.pipe(
      Layer.provide(AutoFallbackCooldownTrackerLive),
      Layer.provide(ProviderUsageTrackerLive),
      Layer.provide(
